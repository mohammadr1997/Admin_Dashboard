                ...
                <Dialog open={!!selectedMessage} onOpenChange={(isOpen) => { if (!isOpen) setSelectedMessage(null); }}>
                  <DialogTrigger asChild>
                    <Button
                      ...
                      className="!bg-[#a5a6a6] cursor-pointer text-white  hover:!bg-[#b9babb]    !font-bold hover:text-white !text-md !lg:text-xl !px-4 !py-2 !rounded-2xl !border-1 !border-gray "
                      variant="ghost"
                    >
                      View Message
                    </Button>
